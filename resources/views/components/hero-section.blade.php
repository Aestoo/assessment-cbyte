<div class="relative isolate overflow-hidden bg-gray-900 px-6 py-5 shadow-2xl rounded-2xl lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
    <svg viewBox="0 0 1024 1024"
        ...
        <defs>
            <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641">
                <stop stop-color="#5044e4"/>
                <stop offset="1" stop-color="#5044e4"/>
            </radialGradient>
        </defs>
    </svg>
