            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8 space-y-5">
                <div class="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p class="mt-6 text-lg/8 text-gray-600">
                        With our advanced tool, share secrets securely without third-party interference.
                    </p>
                </div>
                <x-features-section :features="[
                    ...
                    ['icon' => 'heroicon-o-link', 'title' => 'Signed URLs', 'description' =>  'Allow users to create secure, time-limited links to their sensitive information, ensuring that shared secrets are protected with Laravel\'s robust encryption, and can be easily managed for expiration and access control.'],
